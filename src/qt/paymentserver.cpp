...
const QString BITCOIN_IPC_PREFIX("Woochain:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Woochain: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Woochain: click-to-pay handler");
    else
...
{
    // clicking on Woochain: URLs creates FileOpen events on the Mac:
