    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new WoochainUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->WoochainAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Woochain."), QMessageBox::Ok);
