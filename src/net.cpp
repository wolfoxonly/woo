...
// Copyright (c) 2009-2012 The Woochain Core developers
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Woochain " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
	...
	{"wooexcoin.com","wooexcoin.com"},	  
	{"woodexcoin.com","woodexcoin.com"},	
	{"woodcoinex.com","woodcoinex.com"},	
	{"excoinwood.com","excoinwood.com"},	
	{"exwoocoin.com","exwoocoin.com"},	  
	{"excoinwoo.com","excoinwoo.com"},	  
	{"coinwoodex.com","coinwoodex.com"},	
	{"coinexwood.com","coinexwood.com"},	
	{"coinexwoo.com","coinexwoo.com"},	  
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Woochain is probably already running."), addrBind.ToString().c_str());
        else
