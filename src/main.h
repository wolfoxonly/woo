...
static const int64 MAX_MONEY = 510000000 * COIN;
...
static const int64 MAX_MINT_PROOF_OF_WORK = 0.001 * COIN;//最大挖到的利息值
...
static const int STAKE_MIN_AGE = 60 * 60 * 24 * 364; // minimum age for coin age<coingo.vip>
// static const int STAKE_MAX_AGE = 60 * 60 * 24 * 90; // stake age of full weight
static const int STAKE_MAX_AGE = 60 * 60 * 24 * 365; // stake age of full weight 3年 <coingo.vip>
...
static const uint256 hashGenesisBlockOfficial("0x00000084372c4f6a2301065cc13c7717f4205bec81098ba456be35d5e90db18f");
...
#ifdef TESTING
void WoochainMiner(CWallet *pwallet, bool fProofOfStake, bool fGenerateSingleBlock = false);
#else
...
public:
    ...
    */
    ...
    /** Amount of Woochains spent by this transaction.
    ...
    /** Amount of Woochains coming in to this transaction
...
public:
    ...
    /**
     * Duplicate from Woochainrpc that originaly define this method.
