...
static const int64 MAX_MINT_PROOF_OF_WORK = 0.1 * COIN;//最大挖到的利息值
...
static const int STAKE_MIN_AGE = 60 * 60 * 24 * 2; // minimum age for coin age<coingo.vip>
// static const int STAKE_MAX_AGE = 60 * 60 * 24 * 90; // stake age of full weight
static const int STAKE_MAX_AGE = 60 * 60 * 24 * 365 * 10; // stake age of full weight 3年 <coingo.vip>
