...
By default, Woochaind will dump mempool on shutdown and
...
class MempoolPersistTest(WoochainTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(1)
        self.start_node(2)
        # Give Woochaind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent Woochaind from writing mempool.dat to disk. Verify that `savemempool` fails")
