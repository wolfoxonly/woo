...
Also test that nodes that send unsupported service bits to Woochaind are disconnected
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if Woochaind ban behavior changes
    def on_open(self):
        super().on_open()
...
class P2PLeakTest(WoochainTestFramework):
