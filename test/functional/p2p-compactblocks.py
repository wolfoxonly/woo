...
# TestNode: A peer we use to send messages to Woochaind, and store responses.
...
class CompactBlocksTest(WoochainTestFramework):
    ...
    # This test actually causes Woochaind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that Woochaind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for Woochaind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # Woochaind will not send blocktxn responses for blocks whose height is
