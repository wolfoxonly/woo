...
* Woochain.conf: contains configuration settings for Woochaind or Woochain-qt
* Woochaind.pid: stores the process id of Woochaind while running
...
* debug.log: contains debug information and general logging generated by Woochaind or Woochain-qt
