Woochain Core version 0.9.4 is now available from:

  https://Woochain.org/bin/0.9.4/
...
this update is incompatible with the Woochain system and could lead to consensus
forks.

Woochain Core released binaries from https://Woochain.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~Woochain/+archive/ubuntu/Woochain
- A third-party or self-compiled Woochain Core

upgrade to Woochain Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
