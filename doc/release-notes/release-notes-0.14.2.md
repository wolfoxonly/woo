Woochain Core version 0.14.2 is now available from:

  <https://Woochain.org/bin/Woochain-core-0.14.2/>
...
(in Woochain Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in Woochain-Qt when using coin
...
- #10228 `ae479bc` Regenerate Woochain-config.h as necessary (theuni)
