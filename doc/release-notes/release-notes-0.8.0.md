Woochain-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/Woochain/files/Woochain/Woochain-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Woochain
...
New/changed settings (command-line or Woochain.conf file)
--------------------------------------------------------
