Woochain Core version 0.10.4 is now available from:

  <https://Woochain.org/bin/Woochain-core-0.10.4/>
...
- #6953 `43c2789` Split Woochain-tx into its own package
- #6953 `dfe0d4d` Include Woochain-tx binary on Debian/Ubuntu
