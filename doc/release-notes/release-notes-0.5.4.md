Woochain version 0.5.4 is now available for download at:
http://sourceforge.net/projects/Woochain/files/Woochain/Woochain-0.5.4/
...
http://gitorious.org/Woochain/Woochaind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Woochain-Qt notifications under Growl 1.3.
Increase required age of Woochain-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxWoochain properly when installing Woochain-Qt over it. (Windows)
