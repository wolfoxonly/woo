Woochain Core version 0.13.2 is now available from:

  <https://Woochain.org/bin/Woochain-core-0.13.2/>
...
- #8908 `4a974b2` Update Woochain-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow Woochain-tx to create v2 transactions (btcdrak)
